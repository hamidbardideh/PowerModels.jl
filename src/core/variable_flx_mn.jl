...
function variable_ne_storage(pm::AbstractPowerModel; kwargs...) # it reflects in Prblem definition file!===>    DONE
    ...
    variable_ne_storage_reactive_dch(pm; kwargs...)
...
# function variable_ne_storage_reactive_ch(pm::AbstractPowerModel; nw::Int=pm.cnw, bounded::Bool=true, report::Bool=true)
