...
function constraint_storage_new_chr_dischr_exclusivity(pm::AbstractPowerModel, i::Int; nw::Int=pm.cnw)
    ...
    JuMP.@constraint(pm.model,  ps_ch_new <= max_strg_ch * z_bin )
...
function constraint_power_balance_flx_ne_strg_shed(pm::AbstractPowerModel, i::Int; nw::Int=pm.cnw)
    ...
    constraint_power_balance_flx_ne_strg_shed(pm, nw, i, bus_arcs, bus_arcs_dc, bus_arcs_sw, bus_arcs_ne, bus_gens, bus_storage, bus_storage_new, bus_gs, bus_bs, bus_loads)
end

function constraint_power_balance_flx_ne_strg_shed(pm::AbstractPowerModel, n::Int, i, bus_arcs, bus_arcs_dc, bus_arcs_sw, bus_arcs_ne, bus_gens, bus_storage, bus_storage_new, bus_gs, bus_bs, bus_loads)
...
function constraint_storage_new_sc_ps_qs(pm::AbstractPowerModel, i::Int; nw::Int=pm.cnw)
    ...
    JuMP.@constraint(pm.model, sd_new ^ 2 == ((ps_dch_new ^ 2) + (qs_dch_new ^ 2)) * Z_strg  )
