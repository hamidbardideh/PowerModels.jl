...
function constraint_power_balance_flx_ne_PQshed_Pstrg(pm::AbstractPowerModel, i::Int; nw::Int=pm.cnw)
    ...
    constraint_power_balance_flx_ne_PQshed_Pstrg(pm, nw, i, bus_arcs, bus_arcs_dc, bus_arcs_sw, bus_arcs_ne, bus_gens, bus_storage, bus_storage_new, bus_gs, bus_bs, bus_loads)
end

function constraint_power_balance_flx_ne_PQshed_Pstrg(pm::AbstractPowerModel, n::Int, i, bus_arcs, bus_arcs_dc, bus_arcs_sw, bus_arcs_ne, bus_gens, bus_storage, bus_storage_new, bus_gs, bus_bs, bus_loads)
